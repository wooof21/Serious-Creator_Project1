...
/**
 * @author http://blog.csdn.net/android_dong/article/details/41989499
 * 
 * @param
 * @return
 */
...
public class RoundImageView extends ImageView{
	...
	protected void onDraw(Canvas canvas){
		...
		if(mBorderInsideColor != defaultColor
			...
			// 画外圆
			drawCircleBorder(canvas, radius
					+ mBorderThickness + mBorderThickness
		...
		canvas.drawBitmap(roundBitmap, defaultWidth / 2
				- radius, defaultHeight / 2 - radius, null);
	}
	...
	public Bitmap getCroppedRoundBitmap(Bitmap bmp,
		...
		if(squareBitmap.getWidth() != diameter
			...
			scaledSrcBmp =
					Bitmap.createScaledBitmap(squareBitmap,
		...
		Rect rect =
				new Rect(0, 0, scaledSrcBmp.getWidth(),
						scaledSrcBmp.getHeight());
	...
	private void drawCircleBorder(Canvas canvas,
		...
		canvas.drawCircle(defaultWidth / 2,
				defaultHeight / 2, radius, paint);
	}
}
